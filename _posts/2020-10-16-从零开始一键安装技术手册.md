...
![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/任务.jpg)

![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/任务1.jpg)
...
3. 对每个硬盘的每个分区执行删除命令，其中硬盘为sd(x)(num)或者sd(x)的命名格式。
   ...
   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/fdiskd1.jpg)
...
1. 重启，开机过程中按f2，进入system setup界面
   ...
   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid.jpg)
...
2. 选择device settings，进入integrated raid...，进入controller management，选择clear configuration，清空已有的硬盘raid配置。
   ...
   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid1.jpg)

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid2.jpg)

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid3.jpg)

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid4.jpg)
...
3. 返回上一级，进入virtual disk management，选择create virtual disk，选择创建raid1类型的硬盘，然后点击select physical disk，将前两个硬盘打勾选择，点击apply changes，自动返回上级时再次点击create virtual disk，确认页面确认后才表明改raid盘正式搭建完成。
   ...
   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid5.jpg)

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid7.jpg)

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid6.jpg)

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid8.jpg)

4. 以此类推，将后六个硬盘搭建为raid5.搭建完成后选择view disk group properties检查配置。

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid9.jpg)

5. 左上角esc是返回。不断选择右下角finish，安全保存退出，系统会自动重启。

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/raid10.jpg)

##  安装LINUX系统

1. 重启服务器过程中，将装机U盘插入USB口，按`F11`进入BIOS BOOT Manager界面，选择U盘设备运行，一般为`C`盘下面的最后一个。

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/llinux.jpg)

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/linux.jpg)
...
2. 安装LINUX系统。在LINUX安装界面进行安装，注意使用`TAB`键和`SHIFT+TAB`键进行选择。
   ...
   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/linux2.jpg)

3. 配置完成后，检查无异常状态，即可进行安装。设置完root密码，安装完linux系统后按提示重启，即可进入刚安好的linux系统。

   注意：重启完后，记得拔出U盘

   ![](https://github.com/jiandongg/jiandongg.GitHub.io/pictures/hili_setup/linux4.jpg)
